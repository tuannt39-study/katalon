...
WebUI.setText(findTestObject('Page_Zack Market/input_Email_email'), 'tuannt39@gmail.com')

WebUI.setEncryptedText(findTestObject('Page_Zack Market/input_Password_password'), 'vckfKYHQ/X5a0LrHpsIEKA==')

WebUI.click(findTestObject('Page_Zack Market/input_Required_button_btn_sign_in'))

WebUI.enableSmartWait()

WebUI.verifyElementPresent(findTestObject('Page_Zack Market/div_Zack Market'), 3)
